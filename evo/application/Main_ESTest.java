    ...
    Future<?> future = executor.submit(new Runnable(){ 
          ...
          try { 
            ...
            fail("Expecting exception: SecurityException");
             ...
             //
             // Security manager blocks (\"java.net.SocketPermission\" \"127.0.0.1:2333\" \"connect,resolve\")
             ...
             // application.share.Scoket.init(Scoket.java:34)
             // application.Main.start(Main.java:40)
