 ...
 * The class make the scoket of auction.
 **************************************************/
	...
	private class ClientThread   implements Runnable{
		public void run() {
			try {
				...
				System.out.println("Link exception, the program is about to close, please restart");
				System.exit(1);
			}
		}
		/**
