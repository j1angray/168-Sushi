 ...
 * The class make the scoket of Bank.
 **************************************************/
...
public class BankScoket {
	...
	private String name = "";
	private static String USER_EXIST = "system message: User already existed, please change a name";
	/**
	...
	private class ClientThread   implements Runnable{
		public void run() {
			try {
				...
				new AlertBox().display("Utils.PROMPT", "Link exception, please restart");
		...
		private void dealWithSelectionKey(SelectionKey sk) {
			...
			} catch (IOException e) {new AlertBox().display("Utils.PROMPT", "Link exception, please restart");
